...
<head>
    ...
    <meta name="keywords" content="Learn Blockchain, Public Transport, Web Development Services, Inclusion and Diversity">
    <meta id="token" name="token" value="{{ csrf_token() }}">
    <meta name="google-site-verification" content="eC0Ug40OeDQDrQrfbHIoqp7U-mHbHclTjiuAsMvv1t8" />
    <title>Learn Blockchain | Public Transport | Inclusion and Diversity |@yield('meta-title', 'London UK | Learn Blockchain | Public Transport | Inclusion and Diversity')</title>
