    ...
    <div class="main-container">
        <div class="privacy-container">
            ...
            <div class="heading">
                ...
                <!-- /.featured-image -->
                <h1 class="blog--title is--padded-top-40">Privacy Policy</h1>
                <h2 class="blog--excerpt">What is this privacy policy for?</h2>
                <p class="is--beige is--lower">This privacy policy is for this website www.ormrepo.co.uk and served by Ormrepo and governs the privacy of its users who choose to use it.</p>
                ...
                <h2 class="blog--excerpt">The Website</h2>
                <p class="is--beige is--lower">
                    This website and its owners take a proactive approach to user privacy and ensure the necessary steps are taken to protect the privacy of its users throughout their visiting experience. This website complies to all UK national laws and requirements for user privacy.
                 </p>


                <h2 class="blog--excerpt">Contact & Communication</h2>
                <p class="is--beige is--lower">
                ...
                <h2 class="blog--excerpt">Email Newsletter</h2>
                <p class="is--beige is--lower">
                ...
                <h2 class="blog--excerpt">External Links</h2>
                <p class="is--beige is--lower">
                ...
                <h2 class="blog--excerpt">Adverts & Sponsored Links</h2>
                <p class="is--beige is--lower">
                ...
                <h2 class="blog--excerpt">Social Media Platforms</h2>
                <p class="is--beige is--lower">
                ...
                <h2 class="blog--excerpt">Shortened Links in Social Media</h2>
                <p class="is--beige is--lower">
