        ...
        <div class="privacy-container">
            <div class="heading">
                <div class="featured-image">
                    <img class="img-responsive" src="images/conditions/conditions-300.png" alt="padlock picture">
                </div><!-- /.featured-image -->

                <h1 class="blog--title is--padded-top-40 is--beige">Terms & Conditions</h1>
                ...
                <p class="is--lower">
                    The Developer is a web developer provider offering Laravel, Craft CMS, Javascript, Vue js, React Js,HTML, CSS, PHP & Wordpress and other related computer programming languages.
                </p>
                <h2 class="blog--excerpt">2. Acceptance of work</h2>
                <p class="is--lower">
                    Quotations are valid for 30 days from date of issue.
                </p>

                <p class="is--lower">
                    When the Client places an order to purchase a website or website updates from the Developer, the order represents an offer to the Developer to purchase the website or website updates.
                </p>
                ...
                <p class="is--lower">
                    The Client agrees to pay the Developer 50% of the outstanding fees before work begins on the project and the remaining 50% of the fees are due to be paid on project completion.
                </p>

                <p class="is--lower">
                    The invoice equals acceptance by the Developer (or third party supplier) of the Client’s offer to purchase services from the Developer and this acceptance of work is a valid contract between Client and Developer regardless of whether the Client receives the invoice.
                </p>
                ...
                <p class="is--lower">
                    The Client agrees that the standard development platform is an agreeable platform for development of the website and all acceptance testing will occur only on the standard development platform.
                </p>

                <p class="is--lower">
                    The Client further agrees that any requests relating to hardware or software outside the standard development platform will be deemed additional work.
                ...
                <p class="is--lower">
                    Any work is subject to a minimum charge of £25.
                </p>

                <h2 class="blog--excerpt">3. Material</h2>
                ...
                <p class=" is--lower">
                    The Client agrees to pass on other access details relating to their domain name and hosting account that the Developer requires to upload the website if required as part of a project.
                </p>
                <p class=" is--lower">
                ...
                <h2 class="blog--excerpt">4. Copyright & Permission</h2>
                <p class=" is--lower">
                ...
                <h2 class="blog--excerpt">5. Projects</h2>
                <p class=" is--lower">
                ...
                <p class=" is--lower">
                    All alterations are to be requested in writing either by email or postal mail by the Client.
                    The Developer reserves the right to request payment be received for further alterations before continuing work. Upon completion of agreed design, the Client is asked to confirm in writing by email or postal mail that the design and the screen size is signed off as complete and agree that any further design alterations are chargeable.
                </p>
                <p class=" is--lower">
                ...
                <p class=" is--lower">
                    ...
                    If the Client or a third party of their choosing edits the website code and this results in functionality errors or the page displaying incorrectly, then the Developer reserves the right to quote for work to repair the website.
                </p>
                <p class=" is--lower">
                ...
                <h2 class="blog--excerpt">6. Web Accessibility</h2>
                <p class=" is--lower">
                    The Developer tests sites and templates to ensure they comply with W3C CSS standards as they are at time of sale. Should updated W3C CSS guidelines be introduced after the site or templates were sold to the Client, the Developer reserves the right to quote separately for any additional work needed.
                </p>
                <p class=" is--lower">
                ...
                <h2 class="blog--excerpt">7. Payment Terms</h2>
                <p class=" is--lower">
                ...
                <h2 class="blog--excerpt">8. Liability and warranty disclaimer
                </h2>
                <p class=" is--lower">
                ...
                <p class=" is--lower">
                    The Developer may from time to time recommend to the Client that updates are needed to their site, including but not limited to new legislation compliance, software compatibility and web standards. The Developer reserves the right to quote for any updates as separate work. The Client agrees that the Developer is not liable for any failure to inform or implement these updates to their site.

                </p>
                <p class=" is--lower">
                    The Client agrees that it shall defend, indemnify, save and hold the Developer harmless from any and all demands, liabilities, costs, losses and claims arising from omission to inform or implement these updates.

                </p>

                <h2 class="blog--excerpt">9. Indemnification</h2>
                <p class=" is--lower">
                ...
                <h2 class="blog--excerpt">10. Indisclosure</h2>
                <p class=" is--lower">
                ...
                <h2 class="blog--excerpt">11. Privacy Policy</h2>
                <p class=" is--lower">
                ...
                <h2 class="blog--excerpt">12. Interpretation</h2>
                <p class=" is--lower">
                ...
                <h2 class="blog--excerpt">13. Statutory Rights</h2>
                <p class=" is--lower">
