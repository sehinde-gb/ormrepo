...
<div class="breadcrumb-container">
    ...
    <div class="main-container">
        ...
        <div class="composite-container">
            ...
            <div class="composite-container">
                <div class="single-container">
                    <h5 class="is--black is--capitals">Episode 7: How does implicit bias affect your relationships? </h5>
                    <iframe width="560" height="315" src="https://www.youtube.com/embed/N1mSmFNuJXQ" frameborder="0" allowfullscreen></iframe>
                </div><!-- /.single-container -->


                    <div class="single-container">
                        <h5 class="is--black is--capitals">Episode 8: How we use markdown in mailables for Laravel 5.5 </h5>
            ...
            <div class="composite-container">
                <div class="single-container">
                    <h5 class="is--black is--capitals">Episode 15: How to Build a JobBoard using Laravel 5.5 Part 3 </h5>
                    <iframe width="560" height="315" src="https://www.youtube.com/embed/12PzbXlZkSA" frameborder="0" allowfullscreen></iframe>
                </div><!-- /.single-container -->

                <div class="single-container">
                    <h5 class="is--black is--capitals">Episode 16: Part 1 | Why emotional intelligence is important in the world of tech ? </h5>
