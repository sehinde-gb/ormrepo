...
@section('meta-title', 'Web Development Services, Blockchain Infrastructure | Ormrepo | London UK | Welcome to our Transport Tech Blog ')
                ...
                <div class="col-lg-12">
                    ...
                    <div class="columns is-gapless is-multiline animated rotateInDownLeft">
                        ...
                        @foreach ($blogs as $blog)
                            ...
                            @elseif($blog->id == 36)
                                <div class="column is-one-quarter is-light-grey is-flex is-forty-one">
                                    <div class="arrow">
                                        <div class="indexed-image">
                                            <a href="{{ url('admin/blogs', $blog->id) }}"><img src="{{ asset('featured/images/' . $blog->id. '.png') }}" class="reduction" alt="The uploaded featured image"></a>
                                        </div>
                                ...
                                </div><!-- /.column is-one-quarter is-light-grey is-flex is-forty-one-->
                            ...
                            @elseif($blog->id == 37)
                                ...
                                </div><!-- /.column is-one-quarter is-light-grey is-flex is-forty-two-->
                            ...
                            @elseif($blog->id == 38)
                                ...
                                </div><!-- /.column is-one-quarter is-dark-grey is-flex is-forty-three-->
                            @elseif($blog->id == 39)
                            ...
                            @elseif($blog->id == 49)
                                <div class="column is-one-quarter is-grey is-flex is-fifty-three">
                                    <div class="arrow">
                                        <div class="indexed-image">
                                            <a href="{{ url('admin/blogs', $blog->id) }}"><img src="{{ asset('featured/images/' . $blog->id. '.png') }}" class="reduction" alt="Blockchain Infrastructure Contract "></a>
                                        </div>
                                        <i class="fa fa-long-arrow-left fa-2x"></i>
                                        <h6><a href="{{ url('admin/blogs', $blog->id) }}">{{ $blog->title }}</a></h6>
                                    </div><!-- /.arrow -->
