...
@section('meta-title', 'Transport, Blockchain Infrastructure | Ormrepo | Thank You')
                    ...
                    <div class="col-lg-12">
                        <div class="intro-slider">
                            <div class="courtesy-container">
                                    <h2 class="is--padded-b20 is--padded-t20 is--black">Thank you for purchasing our web service</h2>
                                    <h4 class="is--padded-b20">Your receipt has been sent to your email address</h4>
                                    <h4 class="is--padded-b20">Help us improve our checkout experience by completing a short survey</h4>
